    ...
    <div class="row p-3 custom-font-size-1p2">
        <div class="col">
            <g:each in="${faqList}" var="faq" status="i">
                <div class="row">
                    <div class="col">
                        <a class="custom-faq-question" data-toggle="collapse" href="#multiCollapseExample${i}" role="button" aria-expanded="false" aria-controls="multiCollapseExample1">${i + 1}. ${faq.question}</a>
