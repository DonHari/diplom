...
<body>
    ...
    <div class="row px-3">
        <div class="col">
            ...
            <p class="pb-3">В системі відсутня можливість зареєструватись самостійно. Для реєстрації необхідно отримати лист на пошту, який може відправити тільки администратор</p>
            ...
            <p>Введіть коректну пошту та оберіть роль у системі. Після цього повідомлення буде відправлено на вказану електрону пошту.</p>
