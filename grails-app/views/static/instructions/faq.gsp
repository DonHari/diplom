...
<body>
    <div class="custom-warning-message mx-3">
        ...
        <p>Взагалі, FAQ - це сам список питань, але він може бути розширений</p>
    </div>
    <div class="row px-3">
        <div class="col">
            ...
            <div class="row pb-3">
                ...
                <div class="col">
                    <img src="${assetPath(src: '/static/instructions/faq/1.png')}" class="custom-image-30 shadow"/>
                </div>
            </div>
            ...
            <div class="custom-warning-message">
                ...
                <ul>
                    ...
                    <li class="ml-3">Питання можуть бути для студенту і для абітурієнту. Різниця в сторінках, на яких їх можна переглянути.</li>
                </ul>
            </div>
        </div>
    </div>
