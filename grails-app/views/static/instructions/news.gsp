...
<body>
    <div class="row px-3">
        <div class="col">
            ...
            <div class="row pb-3">
                ...
                <div class="col">
                    <g:clickableImage src="${assetPath(src: '/static/instructions/news/1.png')}" classes="cursor-pointer shadow-lg custom-image-50" onclick="showImagePopup('modalInstructionNews1')" id="instructionNews1" idModal="modalInstructionNews1"/>
                </div>
            </div>
            <g:clickableImage src="${assetPath(src: '/static/instructions/news/2.png')}" classes="cursor-pointer shadow-lg custom-image-70 custom-margin-1p25rem-bot rounded" onclick="showImagePopup('modalInstructionNews2')" id="instructionNews12" idModal="modalInstructionNews2"/>
    ...
    <div class="row px-3">
        <div class="col">
            ...
            <g:clickableImage src="${assetPath(src: '/static/instructions/news/3.png')}" classes="cursor-pointer shadow-lg custom-image-80 mb-3 rounded" onclick="showImagePopup('modalInstructionNews3')" id="instructionNews13" idModal="modalInstructionNews3"/>
            <ol>
            ...
            <g:clickableImage src="${assetPath(src: '/static/instructions/news/4.png')}" classes="cursor-pointer shadow-lg custom-image-80 mb-3 rounded" onclick="showImagePopup('modalInstructionNews4')" id="instructionNews14" idModal="modalInstructionNews4"/>
            <ol>
                <li class="ml-3">Заголовок новини</li>
                <li class="ml-3">Короткий опис новини</li>
                <li class="ml-3">Головна картинка новини</li>
    ...
    <div class="row px-3">
        <div class="col">
            ...
            <g:clickableImage src="${assetPath(src: '/static/instructions/news/5.png')}" classes="cursor-pointer shadow-lg custom-image-80 custom-margin-1p25rem-bot rounded" onclick="showImagePopup('modalInstructionNews5')" id="instructionNews15" idModal="modalInstructionNews5"/>
            ...
            <g:clickableImage src="${assetPath(src: '/static/instructions/news/6.png')}" classes="cursor-pointer shadow-lg custom-image-80 custom-margin-1p25rem-bot rounded" onclick="showImagePopup('modalInstructionNews6')" id="instructionNews16" idModal="modalInstructionNews6"/>
            <p class="pb-3">Після оновлення Ви повернетесь на головну сторінку та біля оновленної новини побачите інформацію про це.</p>
            <g:clickableImage src="${assetPath(src: '/static/instructions/news/7.png')}" classes="cursor-pointer shadow-lg custom-image-80 custom-margin-1p25rem-bot rounded" onclick="showImagePopup('modalInstructionNews7')" id="instructionNews17" idModal="modalInstructionNews7"/>
        </div>
    </div>
</body>
</html>