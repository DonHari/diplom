...
<body>
    <div class="row px-3">
        <div class="col">
            ...
            <div class="row pb-3">
                <div class="col-8">
                    <p class="pb-3">Для редагування основної інформації (П.І.Б., пошта), натисніть кнопку "Мій аккаунт" зправа зверху.</p>
    ...
    <div class="row px-3">
        <div class="col">
            ...
            <div class="row pb-3">
                <div class="col-8">
                    <p class="pb-3">Для зміни свого імені користувача, натисніть кнопку "Мій аккаунт" зправа зверху.</p>
    ...
    <div class="row px-3">
        <div class="col">
            ...
            <div class="row pb-3">
                <div class="col-8">
                    <p class="pb-3">Для зміни свого паролю, натисніть кнопку "Мій аккаунт" зправа зверху.</p>
